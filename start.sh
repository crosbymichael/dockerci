...
# start a worker
# docker run -v /var/run/docker.sock:/var/run/docker.sock -e REDIS=redis.prod.docker:6379 -e NSQD=nsqd.prod.docker:4150 -e TEST_METHOD=binary crosbymichael/dockerci integration
